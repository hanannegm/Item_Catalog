...
item1 = Item(name="flute", user_id=1, description="A musical wind instrument consisting of a tube with a series of fingerholes or keys, in which the wind is directed against a sharp edge, either directly, as in the modern transverse flute, or through a flue, as in the recorder. an organ stop with wide flue pipes, having a flutelike tone.", category=category2)

session.add(item1)
session.commit()

item2 = Item(name="piccolo", user_id=1,  description="Piccolo, in full flauto piccolo, highest-pitched woodwind instrument of orchestras and military bands. It is a small transverse (horizontally played) flute of conical or cylindrical bore, fitted with Boehm-system keywork and pitched an octave higher than the ordinary concert flute.", category=category2)

session.add(item2)
session.commit()

item3 = Item(name="oboe", user_id=1, description="The oboe is a woodwind instrument in the soprano register. The blowing end of the oboe's slim conical tube (head) turns into a small metal pipe to which two reeds are affixed.", category=category2)
